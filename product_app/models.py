...
class Product(models.Model):
    name = models.CharField(max_length = 100, verbose_name = 'product_name', help_text = 'product name should be less than 100 characters')
    description = models.TextField(verbose_name = 'product_description', help_text = 'a simple description about the product')
    seller = models.ForeignKey(Seller, on_delete = models.CASCADE)
    code = models.CharField(max_length = 10, verbose_name = 'product_code', help_text = 'each product code should be unique')
